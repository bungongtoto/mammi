...
/// The [SignIn] class is a StatefulWidget responsible for the sign-in page of the application.
...
/// The private [_SignInState] class is the state of the [SignIn] widget.
