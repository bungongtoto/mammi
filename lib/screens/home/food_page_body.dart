                            ...
                            Row(
                              ...
                              children: [
                                IconAndTextWidget(
                                  ...
                                  text: "${products[index].quantity} available",
                                  iconColor: AppColors.iconColor1,
                                ),
                                IconAndTextWidget(
                                  icon: Icons.price_check,
                                  text: "${products[index].price} FCFA",
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              margin:
                  EdgeInsets.only(left: Dimensions.width20, right: Dimensions.width20, bottom: Dimensions.height20),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radius20),
                  color: Colors.white,
                  boxShadow: const [
